...
public OnPluginStart()
{
	...
	cvarBlockJoinTeamMessage = CreateConVar("sm_blockjointeammessage", "1", "If enabled it blocks join team messages if an administrator joins any team", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	cvarAdminShowMessages = CreateConVar("sm_adminshowmessages", "0", "Shows disconnect/connect/team join messages for admins only (if disconnect message is set to be blocked)", FCVAR_PLUGIN, true, 0.0, true, 1.0);
